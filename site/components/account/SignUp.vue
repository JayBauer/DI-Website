...
<script>
  ...
  export default {
    ...
    computed: {
      formValid() {
        const { phone, email, address, city, province, postal, password, passwordConfirm } = this.valid
        return (phone && email && address && city && province && postal && password && passwordConfirm)
      }
    },
